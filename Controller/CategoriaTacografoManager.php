 ...
 */
class CategoriaTacografoManager extends ApiController
{
        ...
        if ($this->request->isMethod('GET')) {
            ...
            if ($_GET['action'] == 'read') {
                ...
                if (!$query || $query == 'all') {
                    ...
                    $data = ["categoriastacografos" => array_slice($result, $start, $limit), "total" => count($result)];
                ...
                //---------------------------------------- Reading and Search from combobox ---------------------------------------
                    ...
                    $resp_data = ["categoriastacografos" => array_slice($result, $start, $limit), "total" => count($result)];
                    $this->response->setStatusCode(200);
